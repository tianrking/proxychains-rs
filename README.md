...
| Windows | DLL injection + MinHook | Creation-time tree injection, UDP IOCP/completion-routine fixtures, ConnectEx close-cancellation, and proxy-backed RIO send/queue fixtures pass; provider-specific RIO metadata, notifications and receive paths remain incomplete |
